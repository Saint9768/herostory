package org.tinygame.herostory.reflecttest.step030;


import org.tinygame.herostory.reflecttest.step030.entity.UserEntity;
import org.tinygame.herostory.reflecttest.step030.entity.XxxEntity_Helper;
...
public class App030 {
    ...
    static public void main(String[] argvArray) throws Exception {
        (new org.tinygame.herostory.reflecttest.step030.App030()).start();
    }
